...
//implicit wait - 2 seconds time out
	...
	Assert.assertEquals(driver.findElement(By.tagName("p")).getText(), "You are successfully logged in.");//its is used to check the condition
...
public static String getPassword(WebDriver driver) throws InterruptedException
{
	...
	//another way of creation (I)String[] passwordArray2=passwordArray[1].split("'"); (II)passwordArray2[0];
