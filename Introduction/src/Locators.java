...
public class Locators {
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		System.out.println(driver.findElement(By.cssSelector("p.error")).getText());//1st way css selector for error message
		driver.findElement(By.linkText("Forgot your password?")).click();
		
		Thread.sleep(2000);
		
		
		driver.findElement(By.xpath("//input[@placeholder='Name']")).sendKeys("Gokulavanan");//1st way of creating xpath
		
		driver.findElement(By.cssSelector("input[placeholder='Email']")).sendKeys("Gokulavanan31@gmail.com");//second way for css selector
		...
		//other type of xpath it conitain all part of xpath //div[@class='forgot-pwd-btn-container']/button[1]
